...
Route::post('/e_learning2/join', 'E_learning2Controller@class_join');
Route::get('/e_learning2/join2', 'E_learning2Controller@user_index2');
Route::post('/e_learning2/join2/{e_classes_id}', 'E_learning2Controller@class_join2');
