    ...
    <div class="row justify-content-center">
      <div class="col-sm-12">
        ...
        <form @submit.prevent="submit">
          ...
          <div class="form-group row">
            <label for="quest" class="col-sm-1 col-form-label text-primary">問題</label>
          ...
          <div class="form-group row">
            <label for="ans" class="col-sm-1 col-form-label text-danger">正解</label>
